...
local SUITES = {
    ...
    "test_feign",
    "test_aggregator",
    "test_aggregator_identity",
    "test_aggregator_preview",
...
Kit.setSurfaceSource{
    ...
    -- The same reason, for the bus stub in core/Namespace.lua.
    ["LibKa0s-Bus-1.0"]     = shared.mocks.LibStub("LibKa0s-Bus-1.0", true),
}
