...
-- ---------------------------------------------------------------------------
-- What the sibling files (Row_Border, Row_NameCell, Row_Cells) reach back for
-- ---------------------------------------------------------------------------
--
...
NS.RowInternals = {
    ...
    newCell        = newCell,
    -- modules/Row_Border.lua draws the cell outline with these three, resolved
    -- at FILE SCOPE: the same color seams the bar and the text read, and the
    -- border-art resolver that sits with the other media resolvers above.
    RGBA           = RGBA,
    ClassRGB       = ClassRGB,
