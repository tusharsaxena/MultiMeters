...
└── settings/
    ├── Schema.lua      — NS.Schema (162 rows) and the write seam: GetSetting,
...
visibility 17, columns 8, general 21. `profiles` is the only page with zero schema rows: it hosts
