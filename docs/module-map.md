...
└── settings/
    ...
    ├── Schema.lua      — NS.Schema: the 162-row array itself, and nothing else. The
...
visibility 17, columns 8, general 21. Counting them means reading `settings/Schema.lua` alone: the
