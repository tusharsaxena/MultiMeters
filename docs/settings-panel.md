...
`settings/Schema.lua` currently carries **167 rows across 8 page keys** (windows 1, frame 26,
header 35, bars 29, tooltip 30, visibility 17, columns 8, general 21); a ninth registered page,
...
**167 schema rows total.** Five of the nine pages — Frame, Header, Bars, Tooltip, Visibility — draw
