...
`settings/Schema.lua` currently carries **168 rows across 8 page keys** (windows 1, frame 26,
header 36, bars 29, tooltip 30, visibility 17, columns 8, general 21); a ninth registered page,
...
**168 schema rows total.** Five of the nine pages — Frame, Header, Bars, Tooltip, Visibility — draw
